...
$t->app->hook( before_dispatch => sub {
    ...
    # in Catalyst::View::Template::PHP, we had a hook where we could
    # insert these key-value pairs into the params array we were setting
    # up for PHP.  We don't have that (yet?) in MojoX::Plugin::PHP,
    # so put these in the stash too and we can reuse the tests from
